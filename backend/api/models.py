...
class CloudDbInstance(BaseModel):
    ...
    name: str = Field(..., description="A unique identifier/name for this cloud database instance.")
...
class DatabaseConnectionConfig(BaseModel):
    ...
    enable_cloud_db: bool = Field(True, description="Whether cloud synchronization is enabled for this environment.")
    local_db_url: str = Field(..., description="The connection URL for the local database.")
    cloud_dbs: List[CloudDbInstance] = Field(default_factory=list, description="List of cloud database instances for this environment.")
...
class FrontendConfigData(BaseModel):
    ...
    Example:
        ...
        theme: str
    """
    config_json: Dict[str, Any] = Field(..., description="The actual JSON object containing frontend UI configurations.")
