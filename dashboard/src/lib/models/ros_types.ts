...
export interface IRosTypeR2CInterfacesConfigureIoRack {
  request: IRosTypeR2CInterfacesConfigureIoRackRequest;
  response: IRosTypeR2CInterfacesConfigureIoRackResponse;
}

export interface IRosTypeR2CInterfacesConfigureIoRackRequest {
  rack_config: IRosTypeR2CInterfacesIoRackState;
}
...
export interface IRosTypeR2CInterfacesConnectToOpcuaServer {
  request: IRosTypeR2CInterfacesConnectToOpcuaServerRequest;
  response: IRosTypeR2CInterfacesConnectToOpcuaServerResponse;
}

export interface IRosTypeR2CInterfacesConnectToOpcuaServerRequest {
  nodeid: string;
  port: number;
}

export interface IRosTypeR2CInterfacesConnectToOpcuaServerResponse {
  success: boolean;
  message: string;
}
...
export interface IRosTypeR2CInterfacesGetAiStatusResponse {
  success: boolean;
  message: string;
  status: string;
  progress: number;
...
export interface IRosTypeR2CInterfacesIoModuleState {
  stamp: { sec: number, nanosec: number };
  point_states: IRosTypeR2CInterfacesIoPointState[];
  module_type: IRosTypeR2CInterfacesIoModuleStateModuleType;
  module_index: number;
}

export enum IRosTypeR2CInterfacesIoModuleStateModuleType {
  T8PT_DI = 1,
  T16PT_DI = 2,
  T32PT_DI = 3,
  T8PT_DO = 4,
...
export interface IRosTypeR2CInterfacesIoPointState {
  stamp: { sec: number, nanosec: number };
  state: number;
  point_type: IRosTypeR2CInterfacesIoPointStatePointType;
  point_index: number;
}

export enum IRosTypeR2CInterfacesIoPointStatePointType {
  NULL = 0,
  DI = 1,
  DO = 2,
  AI = 3,
...
export interface IRosTypeR2CInterfacesIoRackState {
  stamp: { sec: number, nanosec: number };
  module_states: IRosTypeR2CInterfacesIoModuleState[];
  ip_address: number[];
  port: number;
  rack_name: string;
  rack_index: number;
...
export interface IRosTypeR2CInterfacesIoSystemState {
  stamp: { sec: number, nanosec: number };
  rack_states: IRosTypeR2CInterfacesIoRackState[];
}
...
export interface IRosTypeR2CInterfacesLabelStudioStatus {
  status: string;
  function: string;
}
...
export enum IRosTypeR2CInterfacesOpcuaDataTypeType {
  ...
  TYPE_XMLELEMENT = 16,
  TYPE_NODEID = 17,
  TYPE_EXPANDEDNODEID = 18,
  TYPE_STATUSCODE = 19,
  TYPE_QUALIFIEDNAME = 20,
  TYPE_LOCALIZEDTEXT = 21,
  TYPE_EXTENSIONOBJECT = 22,
  TYPE_DATAVALUE = 23,
  TYPE_VARIANT = 24,
  TYPE_DIAGNOSTICINFO = 25,
}
...
export interface IRosTypeR2CInterfacesSetIoPoint {
  request: IRosTypeR2CInterfacesSetIoPointRequest;
  response: IRosTypeR2CInterfacesSetIoPointResponse;
}

export interface IRosTypeR2CInterfacesSetIoPointRequest {
  rack_index: number;
  module_index: number;
  point_state: IRosTypeR2CInterfacesIoPointState;
}
