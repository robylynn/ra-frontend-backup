...
export class ApplicationServices {
  ...
  public set_state_variable(
    ...
    return this._call_service(
      ...
      request_data,
      () => {
        console.log(`Successfully set state ${state_name} to ${state_value}`);
        if (onSuccess) onSuccess();
      },
      () => {
        console.log(`Failed to set state ${state_name} to ${state_value}`);
        if (onFailure) onFailure();
      },
      (error) => {
...
export class IOCommandServices extends IOServices {
  ...
  public set_digital_output_point(
    ...
    return this._set_io_point(
      ...
      () => {
        console.log(`Failed to set digital output ${point_index} to ${state}`);
        if (onFailure) onFailure();
      },
      (error) => {
        console.log(
  ...
  public set_analog_output_point(
    ...
    return this._set_io_point(
      ...
      () => {
        console.log(`Failed to set analog output ${point_index} to ${state}`);
        if (onFailure) onFailure();
      },
      (error) => {
        console.log(
      ...
      case IOPointType.ANALOG_INPUT: {
        request_data = {
          ...
          config: {
            ...
            max_electrical_value: io_point_configuration.max_signal_v,
            min_electrical_value: io_point_configuration.min_signal_v,
...
export class CameraCommandServices extends CameraServices {
  ...
  public start_camera_stream(
    ...
    this._call_camera_service(
      ...
      (error) => {
        console.log(`Error starting camera ${camera_id} stream:`, error);
        if (onError) onError(error);
      },
      onComplete
    );
  ...
  public stop_camera_stream(
    ...
    this._call_camera_service(
      ...
      (error) => {
        console.log(`Error stopping camera ${camera_id} stream:`, error);
        if (onError) onError(error);
      },
      onComplete
    );
  ...
  public toggle_ai(
    ...
    this._call_camera_service(
      ...
      (error) => {
        console.log(`Error toggling AI for camera ${camera_id}:`, error);
        if (onError) onError(error);
      },
      onComplete
    );
...
export class AITrainingCommandServices extends AITrainingServices {
  ...
  public stop_ai_training(
    ...
    this._call_ai_training_service(
      ...
      () => {
        console.log(`Failed to stop AI training for project ${project_id}`);
        if (onFailure) onFailure();
      },
      (error) => {
        console.log(
  ...
  public deploy_model(
    ...
    this._call_ai_training_service(
      ...
      (result) => {
        console.log(`Successfully deployed model to camera ${camera_id}`);
        if (onSuccess) onSuccess(result);
      },
      () => {
