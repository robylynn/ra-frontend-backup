...
import {
  ...
  IRosTypeR2CInterfacesConfigureCameraStreamResponse,
  IRosTypeR2CInterfacesDetectCamerasResponse,
...
import { ioConfigurationType } from "@/lib/models/autogenerated/configuration_models";
...
export class AITrainingCommandServices extends AITrainingServices {
  ...
  public start_ai_training(
    ...
    this._call_ai_training_service(
      ...
      () => {
        console.log(`Failed to start AI training for project ${project_id}`);
        if (onFailure) onFailure();
      },
      (error) => {
        console.log(
  ...
  public get_projects(
    ...
    this._call_ai_training_service(
      ...
      (result) => {
        console.log(`Successfully retrieved AI training projects; ${result}`);
        if (onSuccess) onSuccess(result);
      },
      () => {
