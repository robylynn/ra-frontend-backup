...
import { apiResponse } from '@/lib/models/autogenerated/system_models';
import {
...
import { z } from 'zod';
import { logMessage } from '../utils/utilities';
...
export type backendApiResponseSchemaType = z.infer<
    typeof backendApiResponseBaseSchema
>;
...
export const createApiResponseSchema = <T>(schema?: z.ZodSchema<T>) => {
    ...
    else return backendApiResponseBaseSchema;
};
