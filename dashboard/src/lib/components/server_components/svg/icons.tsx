...
export const CloseIcon = () => (
    ...
    // >
    //     <title>Close</title>
    //     <path d="M14.348 14.849a1.2 1.2 0 0 1-1.697 0L10 11.103l-2.651 3.746a1.2 1.2 0 0 1-1.697-1.697l3.746-2.651-3.746-2.651a1.2 1.2 0 1 1 1.697-1.697L10 8.897l2.651-3.746a1.2 1.2 0 1 1 1.697 1.697L11.103 10l3.746 2.651a1.2 1.2 0 0 1 0 1.698z" />
    // </svg>
    <svg
        xmlns="http://www.w3.org/2000/svg"
        className="h-6 w-6"
...
export const RobotIcon = () => {
    return (
        ...
        >
            {/* <g> */}
            <path
                d="M202.622,344.796l-6.208,11.926l-0.263,0.484c-14.411,24.499-41.026,39.714-69.478,39.714
		...
		L37.92,412.74h173.617L202.622,344.796z"
            />
            <path
                d="M212.883,59.091L66.446,280.944c-19.578,33.283-8.465,76.172,24.844,95.749
		...
		c7.808-13.288,24.909-17.716,38.187-9.908C154.165,300.161,158.611,317.254,150.794,330.533z"
            />
            <path
                d="M216.401,422.247H34.278c-12.402,0-22.449,10.055-22.449,22.457V512h227.012v-67.296
		C238.841,432.302,228.794,422.247,216.401,422.247z"
            />
            <path
                d="M450.024,185.737c7.184,0,14.082,1.255,20.48,3.559L328.505,19.542c-22.646-24.606-60.956-26.188-85.554-3.535
