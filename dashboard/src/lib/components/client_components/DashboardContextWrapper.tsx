...
import { ioConfigurationType, uiConfigurationType, plotConfigurationType, opcConfigurationType } from '@/lib/models/autogenerated/configuration_models';
...
export default function DashboardContextProvider(props: {
    ...
    const setUIConfigurationAction = createAction<uiConfigurationType>('ui_config/set');
    const setIOConfigurationAction = createAction<ioConfigurationType>('io_config/set');
    const setOPCConfigurationAction = createAction<opcConfigurationType>('opc_config/set');
    const setAvailableDatabaseTablesAction = createAction<{
        tables: availableTables;
    }>('database/tables/set');
    const setPlotConfigurationAction = createAction<plotConfigurationType[]>('ui_config/set_plot_config');
