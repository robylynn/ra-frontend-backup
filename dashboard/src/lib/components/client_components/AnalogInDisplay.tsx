  ...
  return (
    <div>
      ...
      {dashboardContext.ra_ros_websocket ? 
        ...
        <div className="flex flex-row justify-around gap-[10px] max-w-[100%]">
          {values.map((value, index) => (
            ...
            <div key={index} className="flex flex-col items-center">
              ...
              <div
                ...
                className={`flex w-[40px] h-[40px] rounded-[50%] items-center justify-center text-white transition ease-in-out delay-300 bg-${interpolateColor(value)}`}
