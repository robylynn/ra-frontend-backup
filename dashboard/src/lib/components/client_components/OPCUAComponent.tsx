    ...
    const handleConnect = async (endpoint: string) => {
        ...
        dashboardContext.ros_services.opc_services
            .connect_to_server(endpoint, () => {
                showAlert('Connected to OPC Server', 'success', 3000, 'OPC');
                setIsConnected(true);
            })
            .catch((error) => {
                showAlert(`Error: ${error}`, 'error', 3000, 'OPC');
...
const SubscriptionGroup: React.FC<SubscriptionGroupProps> = ({
    ...
    const handleWriteValue = (nodeId, newValue) => {
        ...
        logMessage(
            `Writing value ${newValue} to node ${nodeId}`,
            'debug',
            'OPC'
        );
        ...
        if (dashboardContext?.ros_services?.opc_services) {
            ...
            dashboardContext.ros_services.opc_services.unsubscribe(
                ...
                () => {
                    ...
                    showAlert(message, 'success', 300, 'OPC')
                }
            );
