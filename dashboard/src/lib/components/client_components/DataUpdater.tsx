...
import { uiConfigSchema, UiConfig } from '@/lib/models/ui_configuration';
...
//     //             if (response != null) {
//     //                 const received_configuration = new UIConfiguration(
//     //                     response
//     //                 );
...
//     //                     received_configuration.saved_motion_plot_configuration =
//     //                         received_configuration.motion_plots;
//     //                     received_configuration.saved_io_plot_configuration =
//     //                         received_configuration.io_plots;
...
//                     setDashboardContext({
//                         payload: {
//                             hardware_configuration: new HardwareConfiguration(
//                                 config
//                             ),
//                         },
    ...
    useEffect(() => {
        ...
        const fetchConfig = async () => {
            try {
                ...
                setDashboardContext({
                    payload: { configuration: validatedData as UiConfig },
                    type: 'ui_config/set',
                });
