            ...
            try {
                ...
                if (apiResponse) {
                    if (apiResponse.io_configuration) {
                        ...
                        message = `IO configuration successfully loaded. Client ID: ${apiResponse.client_id}, Last Updated: ${new Date(apiResponse.io_configuration.lastUpdated).toLocaleString()}.`;
                        type = 'success';
                        logMessage(
                    ...
                    if (apiResponse.ui_configuration) {
                        ...
                        message = `UI configuration successfully loaded. Client ID: ${apiResponse.client_id}, Last Updated: ${new Date(apiResponse.ui_configuration.lastUpdated).toLocaleString()}.`;
                        type = 'success';
                        logMessage(
