...
import { PlotConfiguration, PlotConfigurationSchema, PlotConfigurationsSchema } from '@/lib/models/ui_configuration';
...
interface MultiPlotProperties extends PlotConfiguration {
    onEdit: () => void;
    onRemove: () => void;
...
const ImportModal = ({ isOpen, onClose, onImport }) => {
    ...
    const handleImport = () => {
        try {
            const parsedPlots = PlotConfigurationsSchema.parse(JSON.parse(importText));
...
export const MultiPlotComponent = () => {
    ...
    const savePlots = async () => {
        ...
        fetchFromBackendApi(`/api/backend/ui/config/${"abc"}`, 'POST', updatedConfig)
            .then(() => {
                setDashboardContext({
                    payload: plotsToSave,
