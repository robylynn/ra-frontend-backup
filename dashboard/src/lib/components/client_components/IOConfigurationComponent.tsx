...
import { ioModuleTypes } from '@/lib/models/autogenerated/io_modules';
...
const ModuleModal: React.FC<ModuleModalProps> = ({
    ...
    // Only update formData if the module reference changes
    // useEffect(() => {
    //     if (module && module !== initialModuleRef.current) {
    //         setFormData(module);
    //         initialModuleRef.current = module;
    //     }
    // }, [module]);
    ...
    const handleTypeChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
        ...
        //             id: uuidv4(),
        //             // The entire point object from the ioModuleTypes array becomes the point_type
        //             point_type: p,
        //             // A more robust ternary operator
        //             point_value:
        //                 p.type === 'DO'
        //                     ? false
        //                     : ['AO', 'AI'].includes(p.type)
        //                       ? 0 // Set both AO and AI to 0
        //                       : false, // Default for other types
        //         })),
        //     }));
        // }
...
export const IOConfigurationComponent: React.FC = () => {
    ...
    //                 ...prev.rack_config,
    //                 [name]:
    //                     name === 'max_modules' ? parseInt(value) || 0 : value,
    //             },
    //         }));
    //     };
